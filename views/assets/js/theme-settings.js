!(function () {
    ...
    function r(a) {
        ...
        document.getElementById("header-lang-img") &&
            ("en" == a
                ? (document.getElementById("header-lang-img").src = "./views/assets/images/flags/us.svg")
                : "sp" == a
                    ? (document.getElementById("header-lang-img").src = "./views/assets/images/flags/spain.svg")
                    : "gr" == a
                        ? (document.getElementById("header-lang-img").src = "./views/assets/images/flags/germany.svg")
                        : "it" == a
                            ? (document.getElementById("header-lang-img").src = "./views/assets/images/flags/italy.svg")
                            : "ru" == a
                                ? (document.getElementById("header-lang-img").src = "./views/assets/images/flags/russia.svg")
                                : "ch" == a
                                    ? (document.getElementById("header-lang-img").src = "./views/assets/images/flags/china.svg")
                                    : "fr" == a && (document.getElementById("header-lang-img").src = "./views/assets/images/flags/french.svg"),
                localStorage.setItem("language", a),
                null == (l = localStorage.getItem("language")) && r("en"),
                (b = new XMLHttpRequest()).open("GET", "./views/assets/lang/" + l + ".json"),
    ...
    function t() {
        ...
        b &&
            ...
            ((document.querySelector(".sidebar").innerHTML = z),
                ((c = document.createElement("ul")).innerHTML = '<a href="#" class="logo"><img src="./views/assets/img/logo.png" alt="User Image" height="22"></a>'),
